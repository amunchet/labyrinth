...
def test_image_upload(setup):
    ...
    a = unwrap(serve.custom_dashboard_image_upload)(override="floorplan.jpg", filename="floorplan.jpg")
    assert a[1] == 200

    a = unwrap(serve.custom_dashboard_image_upload)(override="broken.jpg", filename="floorplan.jpg")
    assert a[1] == 484
