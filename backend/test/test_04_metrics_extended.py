...
class TestJudgeFunction:
    ...
    def test_judge_datetime_timestamp_conversion(self):
        ...
        service = {"type": "check", "name": "test", "metric": "field", "comparison": "equals", "value": "0"}
...
class TestJudgeCheckFunction:
    ...
    def test_judge_check_no_name_in_metric(self):
        ...
        metric = {"fields": {}}
        service = {"name": "test", "metric": "field", "comparison": "equals", "value": "0"}
    ...
    def test_judge_check_name_mismatch(self):
        ...
        service = {"name": "test2", "metric": "field", "comparison": "equals", "value": "0"}
    ...
    def test_judge_check_equals_string(self):
        ...
        service = {"name": "test", "metric": "status", "comparison": "equals", "value": "running"}
    ...
    def test_judge_check_equals_numeric(self):
        ...
        service = {"name": "test", "metric": "count", "comparison": "equals", "value": 42}
    ...
    def test_judge_check_greater_than(self):
        ...
        service = {"name": "test", "metric": "cpu", "comparison": "greater", "value": 50}
    ...
    def test_judge_check_less_than(self):
        ...
        service = {"name": "test", "metric": "memory", "comparison": "less", "value": 512}
    ...
    def test_judge_check_time_comparison(self):
        ...
        service = {"name": "test", "metric": "last_update", "comparison": "time", "value": 600}  # 600 seconds
    ...
    def test_judge_check_nested_field(self):
        ...
        service = {"name": "test", "metric": "system.cpu", "comparison": "greater", "value": 30}
    ...
    def test_judge_check_invalid_operation(self):
        ...
        service = {"name": "test", "metric": "value", "comparison": "invalid_op", "value": 50}
    ...
    def test_judge_check_no_value(self):
        ...
        metric = {"name": "test", "fields": {"value": 100}}
        service = {"name": "test", "metric": "value", "comparison": "equals"}  # No value
    ...
    def test_judge_check_greater_string_numbers(self):
        ...
        service = {"name": "test", "metric": "value", "comparison": "greater", "value": "50"}
    ...
    def test_judge_check_less_string_numbers(self):
        ...
        service = {"name": "test", "metric": "value", "comparison": "less", "value": "50"}
